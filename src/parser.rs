...
impl Parser {
    ...
    pub fn _declaration(&mut self) -> Result<Box<Statement>, LoxError> {
    ...
    fn declaration(&mut self) -> Result<Box<Statement>, LoxError> {
    ...
    //    }));
    //}
    pub fn block(&mut self) -> Result<Vec<Box<Statement>>, LoxError> {
        let mut statements = Vec::new();
